using PCGameShoppingApp.Data.Static;
using PCGameShoppingApp.Models;
using Microsoft.AspNetCore.Identity;

namespace PCGameShoppingApp.Data
{
    public class AppDbInitializer
    {
        ...
        public static async Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                // Admin user
                const string adminEmail = "Vishal@PCGameShoppingApp.com";
                const string adminPassword = "Vishal@123";
                ...
                // Normal user
                const string userEmail = "user@PCGameShoppingApp.com";
